...
const PrivacyPolicyPage: React.FC<PrivacyPolicyPageProps> = ({
  ...
  return (
    <>
      <ScrollLock />
      <Styled.PageContainer className="privacy-policy">
        ...
        <TouchScrollable>
          <Styled.PageContent>
            <Styled.PrivacyText>
              At Trckr, accessible from www.trckrapp.com, one of our main
              priorities is the privacy of our visitors. This Privacy Policy
              document contains types of information that is collected and
              recorded by Trckr and how we use it. If you have additional
              questions or require more information about our Privacy Policy, do
              not hesitate to contact us. Our Privacy Policy was generated with
              the help of 
              <a
            ...
            <Styled.PrivacyText>
              Trckr legal basis for collecting and using the personal
              ...
              we collect the information: • Trckr needs to perform a contract
              with you • You have given Trckr permission to do so • Processing
              your personal information is in Trckr legitimate interests • Trckr
              needs to comply with the law Trckr will retain your personal
              information only for as long as is necessary for the purposes set
              out in this Privacy Policy. We will retain and use your
            ...
            <Styled.PrivacyText>
              ...
              be removed from our systems, please contact us. In certain
              circumstances, you have the following data protection rights: •
              The right to access, update or to delete the information we have
              on you. • The right of rectification. • The right to object. • The
              right of restriction. • The right to data portability • The right
              to withdraw consent
            </Styled.PrivacyText>

            <Styled.PrivacyTitle>Log Files</Styled.PrivacyTitle>
            <Styled.PrivacyText>
              Trckr follows a standard procedure of using log files. These files
            ...
            <Styled.PrivacyTitle>Cookies and Web Beacons</Styled.PrivacyTitle>
            <Styled.PrivacyText>
              Like any other website, Trckr uses 'cookies'. These cookies are
            ...
            <Styled.PrivacyTitle>Privacy Policies</Styled.PrivacyTitle>
            <Styled.PrivacyText>
              You may consult this list to find the Privacy Policy for each of
              the advertising partners of Trckr. Third-party ad servers or ad
              ...
              that appear on Trckr, which are sent directly to users' browser.
              ...
              content that you see on websites that you visit. Note that Trckr
            ...
            <Styled.PrivacyText>
              Trckr's Privacy Policy does not apply to other advertisers or
            ...
            <Styled.PrivacyTitle>Children's Information</Styled.PrivacyTitle>
            <Styled.PrivacyText>
              Another part of our priority is adding protection for children
              while using the internet. We encourage parents and guardians to
              observe, participate in, and/or monitor and guide their online
              activity. Trckr does not knowingly collect any Personal
            ...
            <Styled.PrivacyText>
              ...
              that they shared and/or collect in Trckr. This policy is not
              applicable to any information collected offline or via channels
              other than this website.
            </Styled.PrivacyText>

            <Styled.PrivacyTitle>Consent</Styled.PrivacyTitle>
            <Styled.PrivacyText>
              By using our website/app, you hereby consent to our Privacy Policy
